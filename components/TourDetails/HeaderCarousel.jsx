...
import { Parallax, Navigation, Pagination, Scrollbar } from "swiper/modules";
...
const HeaderCarousel = ({ images }) => {
  return (
    <section className="w-full relative h-[60vh] px-2 mt-10 md:mt-24 mb-12">
      <div className="rounded-3xl overflow-hidden">
        ...
        <Swiper
          ...
          modules={ [Parallax, Navigation, Pagination, Scrollbar] }
          speed={ 1000 }
          grabCursor={ true }
          scrollbar={ true }
          slidesPerView={ 2 }
